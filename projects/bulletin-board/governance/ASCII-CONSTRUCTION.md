...
### Format A — Classic Object (max 45w × 15h)
...
### Format B — Geometric Frame (max 45w × 15h)
...
### Format C — Typographic (max 45w × 15h)
...
Center the letterform within the 45-character width.
Calculate: (45 - letterform_width) / 2 = left padding spaces.
...
### Format D — Two Column (max 45w × 15h)
...
### Format E — Full Spread (max 45w × 15h)
...
**Width check**
- [ ] Does every line fit within 45 characters?
